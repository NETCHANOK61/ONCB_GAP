        ...
        <div class="container mt-2">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h5>สถานะการนําเข้าข้อมูล -> รายเดือน</h5>
                    <a href="http://192.168.200.101/Kingdom/index.php" target="_blank" rel="noopener noreferrer"> <span><i
                                class="fa fa-share-alt"></i></span> 192.168.200.101/Kingdom/index.php</a>
                </div>
            </div>
            <hr>
            <div class="row">
