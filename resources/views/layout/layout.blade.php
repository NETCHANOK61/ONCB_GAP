                ...
                <div class="sidebar_blog_2">
                    <ul class="list-unstyled components">
                        ...
                        <li><a href="{{ route('importMonths.index') }}"><i class="fa fa-table yellow_color"></i>
                                <span>ระดับอำเภอ</span></a>
                        </li>

                        <h4>การจัดการคำขอสร้างบัญชีใหม่</h4>
                        <li><a href="{{ route('requestProvince') }}"><i class="fa fa-table yellow_color"></i>
                                <span>ระดับจังหวัด</span></a></li>
                        <li><a href="{{ route('requestDistrict') }}"><i class="fa fa-table yellow_color"></i>
                                <span>ระดับอำเภอ</span></a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <ul class="user_profile_dd">
                                        <li>
                                            <a class="dropdown-toggle" data-toggle="dropdown"><img
                                                    ...
                                                    class="name_user">ITC Admin</span></a>
